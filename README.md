...
<p align="center">
<img src="https://github.com/user-attachments/assets/6bdd8192-08ef-4e53-aab6-80b14161f302" width="160"/>
</p>
...
j'intégre en septembre 2026 le **Mastère Manager Infrastructures & Cybersécurité des SI à CESI École d'Ingénieurs**.
...
![Wazuh](https://img.shields.io/badge/Wazuh-3AADCB?style=for-the-badge&logoColor=white)
...
|---|---|---|
| **CESI École d'Ingénieurs** | Mastère Manager Infrastructures & Cybersécurité des SI | Sept. 2026 – 2028 |
...
Mise en place d'un SIEM avec **Splunk** pour centraliser les logs. Intégration d'alertes IDS (Snort) avec visualisation en temps réel.
🔗 [Voir le projet](projects%20/soc-lab)

---

### 🛡️ IDS/IPS Lab – Snort
Règles personnalisées pour détecter scans de ports, DDoS, SSH bruteforce, ICMP et requêtes HTTP suspectes.
🔗 [Voir le projet](projects%20/snort-ids-ips-lab)

---

### 💻 Pentest Lab – Metasploit
Test d'intrusion complet sur Metasploitable : scan Nmap, identification de services, exploitation de vulnérabilités.
🔗 [Voir le projet](projects%20/pentest-lab)

---

### 🌐 Network Architecture Lab
Architecture réseau sécurisée avec segmentation VLAN, services réseau et analyse d'infrastructure en entreprise.
🔗 [Voir le projet](projects%20/network-architecture-lab)

---

### 📋 Analyse de risques SI – SO-EMBALLAGE (MEHARI & EBIOS RM)
Analyse risques SI réelle sur SO-EMBALLAGE (33,8M€ CA, 185 salariés). MEHARI + EBIOS RM, 20 scénarios, modélisation LockBit en 10 phases techniques, ROI 7:1, conformité ISO 27001/27005/RGPD.
🔗 [Voir le projet](projects%20/Analyse-et-Gestion-des-Risques-SI)

---

### 🗂️ GLPI Lab – IT Asset Management
Déploiement complet GLPI : serveur, base de données, gestion de parc et système de tickets.
🔗 [Voir le projet](projects%20/glpi-lab)

---

### 🔑 Cryptography Lab
GnuPG (chiffrement asymétrique, signatures numériques) et OpenSSL (AES, gestion des clés).
🔗 [Voir le projet](projects%20/cryptography-lab)

---

### 🪟 Windows Security Lab
Analyse SAM/SID, gestion des comptes et mécanismes d'authentification Windows.
...
🇬🇧 Anglais : Niveau B2 – Professionnel (lecture technique et documentation)
